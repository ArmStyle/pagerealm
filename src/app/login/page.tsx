...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      setError('root', {
        message: 'Google Login ยังไม่พร้อมใช้งาน'
      });
    }
  };
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center">
          ...
          <div className="mb-6">
            ...
            <p className="text-muted-foreground mt-2">ยินดีต้อนรับกลับมา!</p>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="bg-background px-4 text-muted-foreground">หรือ</span>
              </div>
            </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm">
          <p className="font-medium text-blue-900 mb-2">สำหรับทดสอบ:</p>
